...
let App = {
  ...
  login: async function(userSecret, userPass) {
...
function LoginComponent() {
  let secret = "1.4aBdw1.76BkP9-Wh6SFH-SLSboT-Ug82T4-61TJ6B-kajWc5-5vEUDe-jk";
  let pass = '';
  ...
  return {
    ...
    m('form', { onsubmit: e => {
      ...
      m('input', { type: "text", placeholder: "secret", value: secret, oninput: e => secret = e.target.value }),
      m('input', { type: "password", oninput: e => pass = e.target.value }),
...
window.onload = () => {
  ...
  // Get Invite
  let inviteToken = document.getElementById('ad-target').attributes['data-meeco-invite'].value;
